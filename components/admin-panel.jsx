          ...
          <Tabs defaultValue="users" className="space-y-0">
            <div className="bg-gradient-to-r from-gray-50 to-gray-100/50 border-b border-gray-200/50">
              <div className="overflow-x-auto px-6 py-2">
                <TabsList className="grid w-full grid-cols-9 min-w-[900px] lg:min-w-0 bg-transparent h-14 gap-1">
                  <TabsTrigger
                    value="users"
            ...
            <div className="p-6">
              ...
              {/* Custom Devices Tab */}
              <TabsContent value="custom-devices" className="mt-0">
                <Card className="border-0 shadow-lg bg-gradient-to-br from-white to-indigo-50/30">
                  <CardHeader className="bg-gradient-to-r from-indigo-500/10 to-indigo-600/10 border-b border-indigo-200/30">
                    <CardTitle className="text-xl font-bold text-gray-800 flex items-center gap-3">
                      <Zap className="w-6 h-6 text-indigo-600" />
                      Custom Device Requests
                    </CardTitle>
                    <p className="text-sm text-gray-600 mt-2">Manage custom device development requests from clients</p>
                  </CardHeader>
                  <CardContent className="p-0">
                    <div className="overflow-x-auto">
                      <Table>
                        <TableHeader>
                          <TableRow className="bg-gray-50/50 hover:bg-gray-50/80">
                            <TableHead className="min-w-[150px] font-semibold text-gray-700">Project Name</TableHead>
                            <TableHead className="min-w-[100px] font-semibold text-gray-700">Budget</TableHead>
                            <TableHead className="min-w-[200px] font-semibold text-gray-700">Specifications</TableHead>
                            <TableHead className="min-w-[120px] font-semibold text-gray-700">Timeline</TableHead>
                            <TableHead className="min-w-[120px] font-semibold text-gray-700">Submitted</TableHead>
                            <TableHead className="min-w-[100px] font-semibold text-gray-700">Actions</TableHead>
                          </TableRow>
                        </TableHeader>
                        <TableBody>
                          {customDevices.length === 0 ? (
                            ...
                            customDevices.map((device) => (
                              ...
                              >
                                <TableCell className="font-medium text-gray-800">{device.projectName}</TableCell>
                                <TableCell className="font-semibold text-indigo-700">{device.budget}</TableCell>
                                <TableCell>
                                  <div className="max-w-xs">
                                    <p className="truncate text-gray-600" title={device.specs}>
                                      {device.specs}
                                    </p>
                                  </div>
                                </TableCell>
                                ...
                                <TableCell className="text-gray-500 text-sm">{formatDate(device.createdAt)}</TableCell>
                                <TableCell>
                                    ...
                                    <Dialog>
                                      <DialogTrigger asChild>
                                        <Button
                                          variant="outline"
                                          size="sm"
                                          className="hover:bg-indigo-50 hover:border-indigo-300 transition-all duration-200 rounded-xl bg-transparent"
                                        >
                                          <Eye className="w-4 h-4" />
                                        </Button>
                                      </DialogTrigger>
                                      <DialogContent className="max-w-2xl bg-gradient-to-br from-white to-indigo-50/30">
                                        <DialogHeader>
                                          <DialogTitle className="text-2xl font-bold text-gray-800">
                                            Custom Device Request Details
                                          </DialogTitle>
                                        </DialogHeader>
                                        <div className="space-y-4">
                                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            <div className="p-3 bg-indigo-50/50 rounded-xl">
                                              ...
                                              <p className="text-gray-800">{device.projectName}</p>
                                            </div>
                                            <div className="p-3 bg-indigo-50/50 rounded-xl">
                                              <label className="text-sm font-semibold text-indigo-800">Budget</label>
                                              <p className="text-gray-800">{device.budget}</p>
                                            </div>
                                            <div className="p-3 bg-indigo-50/50 rounded-xl">
                                              <label className="text-sm font-semibold text-indigo-800">Timeline</label>
                                              <p className="text-gray-800">{device.timeline}</p>
                                            </div>
                                            <div className="p-3 bg-indigo-50/50 rounded-xl">
                                              <label className="text-sm font-semibold text-indigo-800">Submitted</label>
                                              <p className="text-gray-800">{formatDate(device.createdAt)}</p>
                                            </div>
                                          </div>
                                          <div className="p-4 bg-gradient-to-r from-indigo-50 to-purple-50 rounded-xl border border-indigo-200/30">
                                            <label className="text-sm font-semibold text-indigo-800">
                                              Specifications
                                            </label>
                                    ...
                                    <Button
                                      ...
                                      onClick={() => {
                                        if (window.confirm("Are you sure you want to delete this request?")) {
                                          handleDeleteDocument("customDevices", device.id)
                                        }
                                      }}
                                      className="bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white border-0 shadow-md hover:shadow-lg transition-all duration-300 rounded-xl"
                                    >
...
// } from "@/lib/firebase"
// import { db } from "@/lib/firebase"
// import { collection, getDocs, query, orderBy, updateDoc, doc, Timestamp, serverTimestamp, deleteDoc } from "firebase/firestore"
// import AdminChatPanel from "./AdminChatPanel"
...
//                                               </div>
//                                               <div className="p-3 bg-blue-50/50 rounded-xl">
//                                                 <label className="text-sm font-semibold text-blue-800">Zip Code</label>
//                                                 <p className="text-gray-800">{user.zipCode}</p>
//                                               </div>
//                                             </div>
//                                           </div>
//                                           {user.verificationFileUrl && (
//                                             <div className="p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-200">
//                                               <label className="text-sm font-semibold text-blue-800">Verification File</label>
//                                               <a
//                                                 href={user.verificationFileUrl}
//                                                 target="_blank"
//                                                 rel="noopener noreferrer"
...
//                           ) : (
//                           consultantApplications.map((application) => (
//                             <TableRow key={application.id} className="hover:bg-emerald-50/50 transition-colors duration-200">
//                               <TableCell className="font-medium text-gray-800">{application.fullName}</TableCell>
//                               <TableCell className="text-gray-600">{application.email}</TableCell>
//                               <TableCell>
...
//                               </TableCell>
//                               <TableCell>{getStatusBadge(application.status)}</TableCell>
//                               <TableCell className="text-gray-500 text-sm">{formatDate(application.createdAt)}</TableCell>
//                               <TableCell>
//                                 <div className="flex flex-wrap gap-2">
//                                   <Dialog>
//                                     <DialogTrigger asChild>
//                                       <Button variant="outline" size="sm" className="hover:bg-emerald-50 hover:border-emerald-300 transition-all duration-200">
//                                         <Eye className="w-4 h-4" />
//                                         <span className="sr-only">View details</span>
//                                       </Button>
//                                     </DialogTrigger>
//                                     <DialogContent className="max-w-2xl mx-4 bg-gradient-to-br from-white to-emerald-50/30">
//                                       <DialogHeader>
//                                         <DialogTitle className="text-2xl font-bold text-gray-800">Consultant Application Details</DialogTitle>
//                                       </DialogHeader>
//                                       <ScrollArea className="max-h-96">
//                                         <div className="space-y-4">
//                                           <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
...
//                                             </div>
//                                             <div className="p-3 bg-emerald-50/50 rounded-xl">
//                                               <label className="text-sm font-semibold text-emerald-800">Specialization</label>
//                                               <p className="text-gray-800">{application.specialization}</p>
//                                             </div>
//                                             <div className="p-3 bg-emerald-50/50 rounded-xl">
//                                               <label className="text-sm font-semibold text-emerald-800">Bio</label>
...
//                                             </div>
//                                             <div className="p-3 bg-emerald-50/50 rounded-xl">
//                                               <label className="text-sm font-semibold text-emerald-800">Membership Fee</label>
//                                               <p className="text-gray-800">${application.membershipFee}</p>
//                                             </div>
//                                             {application.profilePictureUrl && (
//                                       <div className="mb-2 p-3 bg-emerald-50/50 rounded-xl">
//                                         <strong className="text-sm font-semibold text-emerald-800">Profile Picture:</strong>
//                                         <a
//                                           href={application.profilePictureUrl}
//                                           target="_blank"
//                                           rel="noopener noreferrer"
...
//                                     {application.resumeCvUrl && (
//                                       <div className="mb-2 p-3 bg-emerald-50/50 rounded-xl">
//                                         <strong className="text-sm font-semibold text-emerald-800">Resume:</strong>
//                                         <a
//                                           href={application.resumeCvUrl}
//                                           target="_blank"
//                                           rel="noopener noreferrer"
...
//                                 </div>
//                                 <div className="min-w-0">
//                                   <h3 className="font-bold text-xl text-gray-800 truncate">{booking.clientName || booking.name}</h3>
//                                   <p className="text-gray-600 truncate text-lg">{booking.email}</p>
//                                 </div>
//                               </div>
//                               <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
...
//                                 <Dialog>
//                                   <DialogTrigger asChild>
//                                     <Button variant="outline" size="sm" className="w-full sm:w-auto bg-white/80 hover:bg-purple-50 hover:border-purple-300 transition-all duration-200 rounded-xl">
//                                       <Eye className="w-4 h-4 mr-2" />
//                                       View Details
//                                     </Button>
//                                   </DialogTrigger>
...
//                                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
//                                        <div>
//                                          <label className="text-sm font-semibold text-purple-700">Service Type</label>
//                                          <p>{booking.serviceType || "Consultation"}</p>
//                                      </div>
//                                       <div>
//                                          <label className="text-sm font-semibold text-purple-700">Specialty</label>
...
//                                        </div>
//                                        <div>
//                                          <label className="text-sm font-semibold text-purple-700">Assigned Engineer</label>
//                                          <p>{booking.engineerName || "Not assigned"}</p>
//                                        </div>
//                                        <div>
//                                          <label className="text-sm font-semibold text-purple-700">Preferred Date</label>
//                                          <p>{booking.preferredDate || "Not specified"}</p>
//                                        </div>
//                                        <div>
//                                          <label className="text-sm font-semibold text-purple-700">Preferred Time</label>
//                                          <p>{booking.preferredTime || "Not specified"}</p>
//                                        </div>
//                                        {booking.engineerId && (
//                                         <div>
//                                           <label className="text-sm font-semibold text-purple-700">Engineer ID</label>
//                                           <p>{booking.engineerId}</p>
//                                         </div>
//                                       )}
//                                     </div>
...
//                               <div className="flex items-center gap-3 p-3 bg-purple-50/50 rounded-xl">
//                                 <Stethoscope className="w-5 h-5 text-purple-600 flex-shrink-0" />
//                                 <span className="truncate text-gray-700 font-medium">{booking.serviceType || booking.consultationType}</span>
//                               </div>
//                               {booking.preferredDate && (
//                                 <div className="flex items-center gap-3 p-3 bg-purple-50/50 rounded-xl">
//                                   <Calendar className="w-5 h-5 text-purple-600 flex-shrink-0" />
...
//                               <div className="flex items-center gap-3 p-3 bg-purple-50/50 rounded-xl">
//                                 <Calendar className="w-5 h-5 text-purple-600 flex-shrink-0" />
//                                 <span className="text-gray-700 font-medium">{formatDate(booking.createdAt || booking.timestamp)}</span>
//                               </div>
//                             </div>
...
//                             variant="outline"
//                             size="sm"
//                             className="hover:bg-orange-50 hover:border-orange-300 transition-all duration-200 rounded-xl"
//                           >
//                             <Eye className="w-4 h-4" />
//                             <span className="sr-only">View details</span>
//                           </Button>
...
//                                   {/* Detailed Specifications */}
//                                   {device.detailedSpecifications &&
//                                     device.detailedSpecifications.map(
//                                       (spec, index) => (
//                                         <div
//                                           key={`detailed-${index}`}
//                                           className="p-3 bg-orange-50/50 rounded-xl"
...
//                             size="sm"
//                             onClick={() =>
//                               handleDeviceStatusUpdate(device, "approved")
//                             }
//                             className="bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white border-0 shadow-md hover:shadow-lg transition-all duration-300 rounded-xl"
//                           >
//                             <Check className="w-4 h-4" />
...
//                             size="sm"
//                             onClick={() =>
//                               handleDeviceStatusUpdate(device, "rejected")
//                             }
//                             className="bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white border-0 shadow-md hover:shadow-lg transition-all duration-300 rounded-xl"
//                           >
//                             <X className="w-4 h-4" />
...
//                               <TableCell className="text-gray-600">{order.email}</TableCell>
//                               <TableCell className="text-gray-600">{order.phone}</TableCell>
//                               <TableCell className="font-bold text-green-700 text-lg">${order.total?.toFixed(2)}</TableCell>
//                               <TableCell>{getStatusBadge(order.status)}</TableCell>
//                               <TableCell className="text-gray-500 text-sm">{formatDate(order.createdAt)}</TableCell>
//                               <TableCell>
//                                 <div className="flex flex-wrap gap-2">
//                                   <Dialog>
//                                     <DialogTrigger asChild>
//                                       <Button variant="outline" size="sm" className="hover:bg-green-50 hover:border-green-300 transition-all duration-200 rounded-xl">
//                                         <Eye className="w-4 h-4" />
//                                         <span className="sr-only">View details</span>
//                                       </Button>
//                                     </DialogTrigger>
//                                     <DialogContent className="max-w-4xl mx-4 bg-gradient-to-br from-white to-green-50/30">
//                                       <DialogHeader>
//                                         <DialogTitle className="text-2xl font-bold text-gray-800">Order Details - #{order.id.slice(-8)}</DialogTitle>
//                                       </DialogHeader>
//                                       <ScrollArea className="max-h-96">
//                                         <div className="space-y-6">
//                                           <div className="grid gap-6">
...
//                                                 {order.address2 && <div><strong>Address 2:</strong> {order.address2}</div>}
...
//                                           </div>
//                                          <div>
//                                       <h4 className="mb-2 p-4 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl border border-blue-200/30">Ordered Items</h4>
//                                       <div className="space-y-2">
//                                         {order.items?.map((item, index) => (
//                                           <div
//                                             key={index}
...
//                                     <div className="p-4 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl border border-blue-200/30">
//                                     <h4 className="mb-2 p-4 bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200/30">Order Summary</h4>
//                                       <div className="space-y-1 text-sm">
//                                         <div className="flex justify-between">
//                                           <span>Subtotal:</span>
//                                           <span>${order.subtotal?.toFixed(2)}</span>
...
//                                   <Dialog>
//                                     <DialogTrigger asChild>
//                                       <Button variant="outline" size="sm" className="hover:bg-pink-50 hover:border-pink-300 transition-all duration-200 rounded-xl">
//                                         <Eye className="w-4 h-4" />
//                                         <span className="sr-only">View details</span>
//                                       </Button>
//                                     </DialogTrigger>
...
//                                             </div>
//                                             <div className="p-3 bg-pink-50/50 rounded-xl">
//                                               <label className="text-sm font-semibold text-pink-800">How they found us</label>
//                                               <p className="text-gray-800">{fb.howDidYouFind}</p>
//                                             </div>
//                                           </div>
//                                           <div className="p-4 bg-gradient-to-r from-pink-50 to-rose-50 rounded-xl border border-pink-200/30">
//                                             <label className="text-sm font-semibold text-pink-800">Feedback</label>
//                                             <p className="mt-2 text-gray-800 leading-relaxed break-words">{fb.feedback}</p>
//                                           </div>
//                                         </div>
//                                       </ScrollArea>
//                                     </DialogContent>
...
//                           ) : (
//                           featureSuggestions.map((suggestion) => (
//                             <TableRow key={suggestion.id} className="hover:bg-yellow-50/50 transition-colors duration-200">
//                               <TableCell className="font-medium text-gray-800">
//                                 {suggestion.featureCategory}
//                               </TableCell>
//                               <TableCell>
...
//                               </TableCell>
//                               <TableCell>{getStatusBadge(suggestion.status || "pending")}</TableCell>
//                               <TableCell className="text-gray-500 text-sm">{formatDate(suggestion.createdAt)}</TableCell>
//                               <TableCell>
//                                 <div className="flex flex-wrap gap-2">
//                                   <Dialog>
//                                     <DialogTrigger asChild>
//                                       <Button variant="outline" size="sm" className="hover:bg-yellow-50 hover:border-yellow-300 transition-all duration-200 rounded-xl">
//                                         <Eye className="w-4 h-4" />
//                                         <span className="sr-only">View details</span>
//                                       </Button>
//                                     </DialogTrigger>
//                                     <DialogContent className="max-w-2xl mx-4 bg-gradient-to-br from-white to-yellow-50/30">
//                                       <DialogHeader>
//                                         <DialogTitle className="text-2xl font-bold text-gray-800">Feature Suggestion Details</DialogTitle>
//                                       </DialogHeader>
//                                       <ScrollArea className="max-h-96">
//                                         <div className="space-y-4">
//                                           <div className="grid grid-cols-1 gap-4">
...
//                                             </div>
//                                             <div className="p-3 bg-yellow-50/50 rounded-xl">
//                                               <label className="text-sm font-semibold text-yellow-800">Description</label>
//                                               <p className="mt-1 text-gray-700 leading-relaxed">{suggestion.featureDescription}</p>
//                                             </div>
//                                             <div className="p-3 bg-yellow-50/50 rounded-xl">
//                                               <label className="text-sm font-semibold text-yellow-800">Priority</label>
//                                               <p className="text-gray-800">{suggestion.priorityLevel}</p>
//                                             </div>
//                                             <div className="p-3 bg-yellow-50/50 rounded-xl">
//                                               <label className="text-sm font-semibold text-yellow-800">Category</label>
//                                               <p className="text-gray-800">{suggestion.featureCategory}</p>
//                                             </div>
...
//                                       variant="outline"
//                                       size="sm"
//                                       onClick={() => handleFeatureSuggestionStatusUpdate(suggestion.id, "in-progress")}
//                                       className="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white border-0 shadow-md hover:shadow-lg transition-all duration-300 rounded-xl"
//                                     >
//                                       <Clock className="w-4 h-4" />
//                                       <span className="sr-only">In Progress</span>
...
//                           ) : (
//                             customDevices.map((device) => (
//                               <TableRow key={device.id} className="hover:bg-indigo-50/50 transition-colors duration-200">
//                                 <TableCell className="font-medium text-gray-800">{device.projectName}</TableCell>
//                                 <TableCell className="font-semibold text-indigo-700">{device.budget}</TableCell>
//                                 <TableCell>
//                                   <div className="max-w-xs">
...
//                                     <Dialog>
//                                       <DialogTrigger asChild>
//                                         <Button variant="outline" size="sm" className="hover:bg-indigo-50 hover:border-indigo-300 transition-all duration-200 rounded-xl">
//                                           <Eye className="w-4 h-4" />
//                                         </Button>
//                                       </DialogTrigger>
//                                       <DialogContent className="max-w-2xl bg-gradient-to-br from-white to-indigo-50/30">
//                                         <DialogHeader>
//                                           <DialogTitle className="text-2xl font-bold text-gray-800">Custom Device Request Details</DialogTitle>
//                                         </DialogHeader>
//                                         <div className="space-y-4">
//                                           <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
//                                             <div className="p-3 bg-indigo-50/50 rounded-xl">
//                                               <label className="text-sm font-semibold text-indigo-800">Project Name</label>
//                                               <p className="text-gray-800">{device.projectName}</p>
//                                             </div>
//                                             <div className="p-3 bg-indigo-50/50 rounded-xl">
//                                               <label className="text-sm font-semibold text-indigo-800">Budget</label>
...
//                                           </div>
//                                           <div className="p-4 bg-gradient-to-r from-indigo-50 to-purple-50 rounded-xl border border-indigo-200/30">
//                                             <label className="text-sm font-semibold text-indigo-800">Specifications</label>
//                                             <p className="mt-2 text-gray-800 leading-relaxed whitespace-pre-wrap">{device.specs}</p>
//                                           </div>
//                                         </div>
//                                       </DialogContent>
//                                     </Dialog>
